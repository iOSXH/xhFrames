...
- (instancetype)initWithContents:(NSArray <UIView *> *)contents {
    ...
    if (self) {
        ...
        self.maskView = [[UIView alloc] initWithFrame:self.applicationView.bounds];
...
- (void)orientationWillChange {
    ...
    [UIView animateWithDuration:self.theme.animationDuration animations:^{
        self.maskView.frame = self.applicationView.bounds;
...
- (void)presentPopupControllerAnimated:(BOOL)flag {
    ...
    [self.applicationView addSubview:self.maskView];
...
- (UIView *)applicationView{
    return [UIApplication sharedApplication].keyWindow.rootViewController.view?:self.applicationWindow;
//    return self.applicationWindow;
//    return [TBURLRouter currentRootViewController].view;
}
