...
@interface BaseListViewController ()<BaseCellProtocol>
...
- (void)viewDidLoad {
    ...
    if (self.cellType == BaseCellTypeTableCell) {
    ...
    }else if (self.cellType == BaseCellTypeCollectionCell){
...
- (BaseCellType)cellType{
    return BaseCellTypeTableCell;
}

- (RefreshHeaderType)headerType{
    return RefreshHeaderTypeMJ;
}

- (RefreshFooterType)footerType{
    return RefreshFooterTypeMJ;
}
...
- (void)setupRefresh{
    ...
    if (self.headerType == RefreshHeaderTypeSystem) {
    ...
    }else if (self.headerType == RefreshHeaderTypeMJ){
    ...
    if (self.footerType == RefreshFooterTypeMJ) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    BaseCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:[self.cellClass CellReuseIdentifier] forIndexPath:indexPath];
    id data = [self.datas objectAtIndex:indexPath.row];
